        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                ...
                @can('manage_users')
                    ...
                    <li class="kt-menu__item @if( in_array(Route::currentRouteName(),['users.index','users.edit']) ) kt-menu__item--here  @endif">
                        <a href="{{ route('users.index')}}" class="kt-menu__link">
                            ...
                            <span class="kt-menu__link-text">{{ __('Visi vartotojai') }}</span>
                        </a>
                    </li>
                    <li class="kt-menu__item @if( Route::currentRouteName() == 'users.create' ) kt-menu__item--here  @endif">
                ...
                <li class="kt-menu__item @if( in_array(Route::currentRouteName(),['taskparams.index','taskparams.edit','taskparams.show']) ) kt-menu__item--here  @endif">
                    <a href="{{ route('taskparams.index')}}" class="kt-menu__link">
                        <span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24" height="24" />
