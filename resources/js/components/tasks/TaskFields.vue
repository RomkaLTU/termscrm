            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex">
                        ...
                        <button v-if="$can('manage_params')" type="button" class="btn btn-outline-hover-success btn-elevate btn-pill d-flex ml-2" data-toggle="modal" data-target="#task_params_groups_modal">
