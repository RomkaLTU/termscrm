...
(function ($) {
  ...
  $(function () {
    ...
    var checkedCompleted = [];
    var contractid = false;
    var $params = $('.select2_task_params');
    var $select2_task_params_groups = $('.select2_task_params_groups');
    var $select2 = $('.select2'); // ----------------------------------
    // Check tasks
    // ----------------------------------
    ...
    $save_completed.on('click', function () {
      alert('In progress...'); // axios.post(`visits`, {
      ...
      $table.DataTable({
        ...
        columnDefs: [{
          ...
          'render': function render(data, type, row) {
            return "\n                            <label class=\"kt-checkbox\">\n                                <input class=\"completed\" type=\"checkbox\" name=\"completed[]\" value=\"".concat(row.DT_RowData.taskid, "\"> &nbsp;\n                                <span></span>\n                            </label>\n                        ");
          }
        }, {
          targets: -2,
          title: 'Istorija',
          ...
          'type': 'html',
          'render': function render(data, type, row) {
            return "\n                            <button data-toggle=\"modal\" \n                                data-contractid=\"".concat(row.DT_RowData.contractid, "\" \n                                data-objectid=\"").concat(row.DT_RowData.objectid, "\" \n                                data-taskid=\"").concat(row.DT_RowData.taskid, "\" \n                                data-target=\"#tasks_history\" class=\"btn btn-outline-brand btn-sm\">\n                                Per\u017Ei\u016Breti\n                            </button>\n                        ");
          }
        }, {
          targets: -1,
          title: 'Veiksmai',
...
/***/ 2:
/*!*************************************!*\
  !*** multi ./resources/js/tasks.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/romas/Projects/VALET/termscrm/resources/js/tasks.js */"./resources/js/tasks.js");
