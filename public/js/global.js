...
(function ($) {
  ...
  $(function () {
    ...
    // ---------------------------------
    var $visit_history_modal = $('#visit_history');
    var $visit_history_content = $('#visit_history_content');
    $visit_history_modal.on('show.bs.modal', function (e) {
      ...
      var visits_html = '';
      axios.get("visits/".concat(contractid, "/").concat(objectid)).then(function (response) {
        var visits = response.data;

        if (visits.length) {
          visits_html += "<div class=\"kt-list-timeline\" v-if=\"visits.length\"><div class=\"kt-list-timeline__items\">";
          visits.forEach(function (visit) {
            visits_html += "\n                            <div class=\"kt-list-timeline__item\">\n                                <span class=\"kt-list-timeline__badge\"></span>\n                                <span class=\"kt-list-timeline__text\">".concat(visit.user.name, "</span>\n                                <span class=\"kt-list-timeline__time\">").concat(visit.created_at, "</span>\n                            </div>\n                        ");
          });
          visits_html += "</div></div>";
        } else {
...
module.exports = __webpack_require__(/*! /Users/romas/Projects/VALET/termscrm/resources/js/global.js */"./resources/js/global.js");
